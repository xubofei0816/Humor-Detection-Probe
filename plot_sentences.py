...
for task in ['conflict_type']:#, 'coordination_inversion', 'obj_number', 'odd_man_out', 'past_present', 'sentence_length', 'subj_number', 'top_constituents', 'tree_depth', 'word_content']:
    seed = 0
    with open(f'output/{task}/{seed}/best.json') as best_epoch_file:
    ...
    gridloc.load_checkpoint(f'output/{task}/{seed}/epoch_{best_epoch}.pt')
